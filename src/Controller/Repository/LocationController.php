...
class LocationController extends AbstractController
{
    ...
    /**
     * @Route("/get-districts/{id}", name="_get_districts")
     * @param $id
     * @return \Symfony\Component\HttpFoundation\JsonResponse
     * @throws \ReflectionException
     */
    ...
    {
        $request = new Request("Repository", "Location", "get_districts");

        $districtModel = new \Matican\Models\Repository\DistrictModel();
        $districtModel->setCityId($id);
